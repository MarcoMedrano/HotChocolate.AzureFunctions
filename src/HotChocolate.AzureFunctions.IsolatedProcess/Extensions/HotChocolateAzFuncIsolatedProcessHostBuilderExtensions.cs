...
public static class HotChocolateAzFuncIsolatedProcessHostBuilderExtensions
{
    ...
    /// <summary>
    /// Adds an implementation of IGraphQLRequestExecutor that supports default or multiple schemas for
    /// Azure Functions Isolated processing model.
    /// </summary>
    /// <param name="hostBuilder">
    /// The <see cref="IFunctionsHostBuilder"/>.
    ...
    /// </returns>
    /// <exception cref="ArgumentNullException">
    /// The <see cref="IHostBuilder"/> is <c>null</c>.
    /// </exception>
    public static IHostBuilder AddGraphQLFunctions(this IHostBuilder hostBuilder)
    {
        if (hostBuilder is null)
        {
            throw new ArgumentNullException(nameof(hostBuilder));
        ...
        hostBuilder.ConfigureServices(s => s.AddGraphQLFunctions());
